...
export default function Welcome({ auth }) {
    return (
        <div className="bg-[#F9F9F7] min-h-screen font-serif text-[#1A1A1A] selection:bg-[#C5A059] selection:text-white overflow-x-hidden">
            <Head title="Blueprint - Elite Design & Details" />

            {/* Navigation */}
            <nav className="fixed top-0 w-full z-50 bg-[#F9F9F7]/90 backdrop-blur-md border-b border-[#E0E0E0] px-8 py-6 flex justify-between items-center">
                <div className="flex flex-col items-start">
                    <span className="text-2xl italic tracking-[0.2em] uppercase text-[#1A1A1A]">Blueprint</span>
                    <span className="text-[8px] uppercase tracking-[0.3em] text-[#C5A059] font-sans font-bold mt-1">Elite Design & Details</span>
                </div>
            ...
            <section className="pt-40 pb-20 px-8 text-center relative overflow-hidden">
                ...
                >
                    <span className="text-[10px] uppercase tracking-[0.5em] text-[#C5A059] font-sans font-bold mb-6 block">SaaS para Planners & Eventos Exclusivos</span>
                    <h1 className="text-6xl md:text-8xl font-light leading-tight mb-8">
                        Donde la Elegancia <br />
                        <span className="italic text-[#C5A059]">encuentra la Logística</span>
                    </h1>
                    <p className="text-xl text-gray-500 font-light max-w-2xl mx-auto mb-12 leading-loose">
                        Crea experiencias memorables para tus clientes más exclusivos. Transforma la gestión de invitados con confirmación en tiempo real y diseño de élite.
                    </p>
            ...
            <section className="py-32 px-8 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
                    <div>
                        ...
                        <h3 className="text-2xl font-light mb-4 text-[#1A1A1A]">Diseño a Medida</h3>
                        <p className="text-gray-400 font-light leading-relaxed">Editor visual avanzado con previsualización en tiempo real para móviles de última generación.</p>
                    </div>
                    <div>
                        <span className="text-[#C5A059] text-5xl font-serif italic mb-6 block">02</span>
                        <h3 className="text-2xl font-light mb-4 text-[#1A1A1A]">Gestión Logística</h3>
                        <p className="text-gray-400 font-light leading-relaxed">Control total de invitados, grupos familiares, alérgenos y control de acceso con códigos QR.</p>
                    </div>
                    <div>
                        <span className="text-[#C5A059] text-5xl font-serif italic mb-6 block">03</span>
                        <h3 className="text-2xl font-light mb-4 text-[#1A1A1A]">Branding Agencia</h3>
                    ...
                    <div className="relative w-[320px] h-[640px] bg-white rounded-[50px] border-[10px] border-[#1A1A1A] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden">
                        ...
                        <div className="p-8 pt-12 text-center h-full flex flex-col justify-center items-center">
                            <div className="w-12 h-12 border border-[#C5A059] rounded-full flex items-center justify-center mb-6">
                                <span className="text-[#C5A059] text-lg italic font-serif">BP</span>
                            </div>
                            <h4 className="text-3xl mb-4 leading-tight text-[#1A1A1A]">Juan & Maria</h4>
                            <p className="text-xs uppercase tracking-widest text-gray-400 mb-8 font-sans">10 de Octubre, 2026</p>
            ...
            <footer className="bg-[#1A1A1A] py-20 px-8 text-center text-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-4xl italic mb-2 uppercase tracking-[0.2em] text-[#C5A059]">Blueprint</h2>
                    <p className="text-[10px] uppercase tracking-[0.3em] text-gray-400 font-sans font-bold mb-12">Elite Design & Details</p>
                    
                    <div className="flex justify-center gap-12 text-[10px] uppercase tracking-widest text-[#888888] font-bold mb-12 font-sans">
                    ...
                    <p className="text-[10px] uppercase tracking-widest text-[#555555] font-sans">© {new Date().getFullYear()} Blueprint. Todos los derechos reservados.</p>
                </div>
            </footer>
        </div>
    );
