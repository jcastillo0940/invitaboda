...
export default function GuestLayout({ children }) {
    return (
        <div className="flex min-h-screen bg-[#F9F9F7] font-serif selection:bg-[#C5A059] selection:text-white">
            {/* Left Side: Brand Experience (Desktop) */}
            <div className="hidden lg:flex w-1/2 bg-[#1A1A1A] items-center justify-center p-20 relative overflow-hidden">
                ...
                >
                    <div className="inline-block border-2 border-[#C5A059] p-8 mb-8">
                        <h1 className="text-5xl text-[#C5A059] italic uppercase tracking-[0.2em]">Blueprint</h1>
                        <p className="text-[#C5A059] font-sans tracking-[0.5em] text-[10px] uppercase mt-2">Elite Design & Details</p>
                    </div>
            ...
            {/* Right Side: Form Content (Mobile & Desktop) */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white lg:bg-transparent">
                ...
                >
                    {/* Mobile Header (Corregido a Blueprint) */}
                    <div className="lg:hidden text-center mb-12">
                        <h1 className="text-3xl text-[#1A1A1A] italic uppercase tracking-widest font-bold">Blueprint</h1>
                        <p className="text-[#1A1A1A] font-sans tracking-[0.3em] text-[9px] uppercase mt-2">Elite Design & Details</p>
                        <div className="w-12 h-px bg-[#C5A059] mx-auto mt-4"></div>
                    </div>

                    {/* El contenedor donde irán los formularios de login/registro */}
