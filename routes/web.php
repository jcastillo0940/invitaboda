...
Route::middleware('auth')->group(function () {
    ...
    // ── Facturación y Manejo de Suscripción ──────────────────────────────────
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // GESTIÓN MANUAL DE SUSCRIPCIONES DE CLIENTES
    Route::resource('/user-subscriptions', \App\Http\Controllers\Admin\UserSubscriptionController::class)->only(['index', 'store', 'update']);
});
...
// ⚠️ Catch-all SIEMPRE AL FINAL — debe ir después de todas las rutas
